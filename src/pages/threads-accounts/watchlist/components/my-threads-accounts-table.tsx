          ...
          <Table className="min-w-full">
            <TableHeader>
              <TableRow>
                ...
                <TableHead className="w-[80px] min-w-[80px] max-w-[80px] px-[10px] text-center">
                  Actions
                </TableHead>
              </TableRow>
            </TableHeader>
              ...
              {currentRecords.length === 0 ? (
                ...
                currentRecords.map((account) => (
                  <TableRow key={account.id}>
                    ...
                    <TableCell className="align-top py-4">
                      <div className="flex flex-col gap-1">
                        <div className="flex items-center gap-2">
                          ...
                          {account.isPrimary && (
                            <Badge variant="primary" appearance="light" className="flex items-center gap-1 text-xs">
                    ...
                    <TableCell className="align-top px-[10px] py-4 text-right">
                      <DropdownMenu>
